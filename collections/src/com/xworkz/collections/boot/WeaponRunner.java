...
public class WeaponRunner {
	...
	public static void main(String[] args) {
		...
		weaponDTOs.add(new WeaponDTO("Antiaircraft gun", "Neeraj", LocalDate.of(2022, 01, 01), 100D, WeaponType.Artillery));
		weaponDTOs.add(new WeaponDTO("Anthrax", "Shashi", LocalDate.of(2020, 05, 13), 2010D, WeaponType.Semiautomatic));
		weaponDTOs.add(new WeaponDTO("Ak47", "Darshan", LocalDate.of(1998, 11, 14), 21000D, WeaponType.Firearms));
		weaponDTOs.add(new WeaponDTO("M416", "Sudeep", LocalDate.of(1890, 01, 13), 2000D, WeaponType.Semiautomatic));
		weaponDTOs.add(new WeaponDTO("Grossa", "Yash", LocalDate.of(1942, 02, 14), 18000D, WeaponType.Firearms));
		weaponDTOs.add(new WeaponDTO("M4A16", "Omkar", LocalDate.of(1997, 03, 15), 1700D, WeaponType.ICBM));
		weaponDTOs.add(new WeaponDTO("AWM", "Srisham", LocalDate.of(1998, 07, 16), 160D, WeaponType.LanceMissile));
		weaponDTOs.add(new WeaponDTO("Kar98", "Anusha", LocalDate.of(1780, 02, 20), 1500D, WeaponType.Firearms));
		weaponDTOs.add(new WeaponDTO("Cannon", "Nayana", LocalDate.of(1942, 04, 27), 1400D, WeaponType.LanceMissile));
		weaponDTOs.add(new WeaponDTO("UMP", "Vinay", LocalDate.of(1893, 03, 30), 1300D, WeaponType.Firearms));
		weaponDTOs.add(new WeaponDTO("Grenade", "Vivek", LocalDate.of(2001, 04, 29), 1100D, WeaponType.Manual));
		weaponDTOs.add(new WeaponDTO("Smoke", "Akhil", LocalDate.of(2002, 10, 18), 1000D, WeaponType.LanceMissile));
		weaponDTOs.add(new WeaponDTO("Air gun", "Vijay", LocalDate.of(1989, 11, 19), 1200D, WeaponType.Firearms));
		weaponDTOs.add(new WeaponDTO("Anthrax", "Ravi", LocalDate.of(1990, 07, 20), 120D, WeaponType.LanceMissile));
		weaponDTOs.add(new WeaponDTO("German 88", "Spoorthy", LocalDate.of(1991, 06, 23), 100D, WeaponType.ICBM));
		weaponDTOs.add(new WeaponDTO("Greek fire", "Likitha", LocalDate.of(1992, 05, 24), 600D, WeaponType.Firearms));
